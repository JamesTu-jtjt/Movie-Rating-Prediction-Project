...
filtering), but also improving the user experience of streaming platforms (userbased filtering). With all that said, our goal is to find the indicators that affect 
...
renamed the average rating column “other_rating” (IMDB) to not get confused 
...
rating_mean, rating_count, vote_mean, and vote_count to represent each director, 
...
and the total number of votes from all the movies they have participated in. Our 
...
Director_Dict, Cast_Dict, and Companies_Dict. These dictionaries are created by 
functions defined in our code and have each director, actor, and company name as 
their keys and lists containing rating_mean, rating_count, vote_mean, and 
vote_count as values for reference. Creating these dictionaries is extremely time 
...
features. Since each movie has only one director, the Director_Dict can be directly 
...
data that correspond to each actor and company in the Cast_Dict and 
Companies_Dict. Since we realized that the list of actors in the cast column is 
...
Conclusion: 
The above concludes our work of preprocessing the data for feature extraction. It 
...
because these variables are evaluated by IMDB ratings and popular actors work 
...
each genre). 
As we can see, the average rating of all genres is approximately 6. Therefore, 
...
'director_rating_mean', 'director_rating_count', 'director_vote_mean', 
'director_vote_count', 'cast_rating_mean', 'cast_rating_count', 'cast_vote_mean', 
'cast_vote_count', 'companies_rating_mean', 'companies_rating_count', 
'companies_vote_mean', 'companies_vote_count', 'other_rating', 'popularity', 
'num_votes'] + [20 genres + 36 production countries] (binary values)
Dropped Features RMSE
['title', 'id', 'revenue', 'collection', 
'Rating', 'popularity', ’budget’,
'director_vote_count', 'cast_vote_count', 
'companies_rating_count', 
'companies_vote_count']
2.5305
...
'companies_vote_count', 
'companies_vote_mean']
['title', 'id', 'Rating', 'revenue', 'budget', 
'collection', 'popularity', 
'cast_vote_mean', 'cast_vote_count', 
'companies_rating_count', 
'companies_vote_mean', 
'companies_vote_count']
2.2192
...
0.9002
['title', 'id', 'Rating', 'revenue', 'budget', 
'cast_vote_mean', 'director_vote_mean', 
'popularity', 'companies_vote_mean']
0.9105
['title', 'id', 'Rating', 'revenue', 'budget', 
'collection', 'popularity', 
'director_vote_mean', 
'director_vote_sum', 'cast_vote_mean', 
'cast_vote_count', 
'companies_rating_count', 
'companies_vote_mean', 
'companies_vote_count']
...
['date', 'runtime', 'director_rating_mean', 'director_rating_count', 
'cast_rating_mean', 'cast_rating_count', 'companies_rating_mean', 
'other_rating', 'num_votes'] + [20 genres and 36 production countries] = 65 
in total. 
...
Therefore, we selected Random Forest Regressor with min_samples_split = 20 to 
...
Theoretically, the more ratings the user gives, the more precise our predictions will 
...
Step 4: Enter movie name, according to our example, we will choose “Star Wars” 
